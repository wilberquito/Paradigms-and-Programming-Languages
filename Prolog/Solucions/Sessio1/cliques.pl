...
%Les arestes no son dirigides, pero s'especifiquen repeticions i ordenades lexicograficament
...
%Alternativa menys eficient. Tot i que es correcta, la opcio anterior es millor, perque demostrar aresta es molt mes facil que demostrar clique3.
